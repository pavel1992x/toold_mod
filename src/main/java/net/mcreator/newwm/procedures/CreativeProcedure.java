...
public class CreativeProcedure extends NewWmModElements.ModElement {
	public CreativeProcedure(NewWmModElements instance) {
		super(instance, 37);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				NewWmMod.LOGGER.warn("Failed to load dependency entity for procedure Creative!");
			return;
		}
