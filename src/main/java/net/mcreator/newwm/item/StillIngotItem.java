...
public class StillIngotItem extends NewWmModElements.ModElement {
	@ObjectHolder("new_wm:still_ingot")
	public static final Item block = null;
	public StillIngotItem(NewWmModElements instance) {
		super(instance, 1);
	}
