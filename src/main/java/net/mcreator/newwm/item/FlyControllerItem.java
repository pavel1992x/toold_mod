...
import net.mcreator.newwm.gui.GuiFlyControllerGui;
...
public class FlyControllerItem extends NewWmModElements.ModElement {
	@ObjectHolder("new_wm:fly_controller")
	public static final Item block = null;
	public FlyControllerItem(NewWmModElements instance) {
		super(instance, 32);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof GuiFlyControllerGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("fly_controller");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("контроллер полёта");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new GuiFlyControllerGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
