...
public class GravititItem extends NewWmModElements.ModElement {
	@ObjectHolder("new_wm:gravitit")
	public static final Item block = null;
	public GravititItem(NewWmModElements instance) {
		super(instance, 28);
	}
